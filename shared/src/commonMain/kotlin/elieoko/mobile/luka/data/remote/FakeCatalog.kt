...
object FakeCatalog {
    ...
    val offers = listOf(
        ...
        JobOffer("o20", "Data analyst junior", "INS RDC", "https://ui-avatars.com/api/?name=INS&background=1B5E20&color=fff", Profession.SOFTWARE_ENGINEERING, "kinshasa", "Kinshasa", "CDD", "900 – 1 300 USD", "Tableaux de bord emploi et statistiques provinciales.", "https://www.ins.cd/carriere", ago(9), false),
    )
    ...
    val ads = listOf(
        ...
        PlatformAd("ad3", "Offres mines Kolwezi", "Les métiers support recrutent aussi.", "Voir Plus", "ad_news", "plan:plus"),
    )

    val news = listOf(
        NewsItem("n1", "Kinshasa concentre 48 % des offres tech", "Les telcos et banques digitalisent plus vite que le reste du pays.", "Luka Insights", "ad_news", ago(1), "https://luka.cd/news/kinshasa-tech"),
        ...
        NewsItem("n3", "Les jeunes du Kivu se forment en ligne", "Goma et Bukavu voient émerger des hubs numériques.", "Luka Orient", "onboarding_learn", ago(5), "https://luka.cd/news/kivu"),
        NewsItem("n4", "Finance : les fintechs recrutent des comptables data", "Le couple Excel + SQL devient un standard à Kinshasa.", "Luka Plus", "profession_finance", ago(8), "https://luka.cd/news/fintech"),
    )
    ...
    val stats = listOf(
        DemandStat(Profession.SOFTWARE_ENGINEERING, 1860, 34, "+18 %"),
        DemandStat(Profession.FINANCE, 1210, 22, "+9 %"),
        DemandStat(Profession.CYBER_SECURITY, 980, 18, "+24 %"),
        DemandStat(Profession.MANAGEMENT, 740, 13, "+6 %"),
        DemandStat(Profession.HUMAN_RESOURCES, 510, 9, "+4 %"),
        DemandStat(Profession.OTHER, 220, 4, "+2 %"),
    )
}
